...
export default function Features() {
    return (
        ...
        <section className="features-one" style={{marginBottom:50}}>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div className="features-one__single">
                            ...
                            <div className="features-one__single-content">
                                <h2><Link href="#">MobileNet V3</Link></h2>
                                <p>Write About The Model Here : It is a long established fact that a reader be distracted by the readable
                                    content.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div className="features-one__single">
                            ...
                            <div className="features-one__single-content">
                                <h2><Link href="#">InceptionNet</Link></h2>
                                <p>Write About The Model Here : It is a long established fact that a reader be distracted by the readable
                                    content.</p>
                            </div>
                        </div>
